...
Docker on my machine. That matters, because it means the agent works against a <b>real</b>,
...
<table>
  ...
  <tr><td>Financial year</td><td>April 1 to March 31, with explicit FY ranges spelled out. "Compare FY 2024-25 vs 2025-26" is the most common question in a family business.</td></tr>
  <tr><td>NULL SalesmanID</td><td><code>trnSales.SalesmanID</code> is NULL for most rows. The authoritative field is on the line items, and the prompt includes the exact three-table join so salesperson leaderboards come out right the first time.</td></tr>
...
<div class="cardgrid">
  ...
  <div class="card">
    ...
    <p>Doesn't render anything on the server. Validates <code>payload.type</code> and returns the payload as JSON, and the frontend does the rest.</p>
  </div>
</div>
